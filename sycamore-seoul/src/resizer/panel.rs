...
pub fn handle_panel_mousemove<G: GenericNode>(is_lateral: bool, to_left: bool, min_length: Option<StyleLength>, max_length: Option<StyleLength>, resizer_rf: NodeRef<G>, e: MouseEvent)
-> Option<f64>
{
  ...
  if limit_check{
    Some(set_percent_length_style(is_lateral, element, to_percent_length))
  } else {
    None
  }
}
